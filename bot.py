...
class bmb_social_media_bot:
    ...
    async def _handle_root(self, request: web.Request) -> web.Response:
        return web.Response(text="Bmb Social Media Bot - FREE Version is running!")
    ...
    async def run(self) -> None:
        try:
            if self.mode == "polling":
                ...
                logger.info("Bmb Social Media Bot - FREE Version started successfully!")
...
async def main() -> None:
    logger.info("Starting Bmb Social Media Bot - FREE Version in %s mode", (BOT_MODE or "webhook"))

    bot_app = bmb_social_media_bot()
    try:
        await bot_app.run()
    except KeyboardInterrupt:
